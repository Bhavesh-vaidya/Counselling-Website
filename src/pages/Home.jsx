  ...
  return (
    <div className="w-full bg-[#fcfbf9] text-[#333333] font-sans">
      ...
      <section className="bg-[#f4f3ef] w-full py-16 md:py-24 relative">
        {/* Floating WhatsApp Icon (Optional: Move to App.jsx to make global) */}
        <div className="absolute -top-6 right-8 bg-[#25D366] p-4 rounded-full shadow-lg cursor-pointer hover:scale-105 transition-transform">
